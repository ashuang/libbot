...
macro(lcmtypes_build_c)
    ...
    add_custom_target(lcmgen_c ALL COMMAND 
        sh -c 'lcm-gen --lazy -c ${_lcmtypes} --c-cpath ${_lcmtypes_c_dir} --c-hpath ${_lcmtypes_c_dir}')
...
macro(lcmtypes_build_java)
    ...
    add_custom_command(OUTPUT ${_lcmtypes_class_files} COMMAND 
        ${JAVA_COMPILE} -source 6 -cp ${_lcmtypes_java_dir}:${LCM_JAR_FILE} ${_lcmtypes_java_files} DEPENDS ${_lcmtypes_java_files} VERBATIM)
