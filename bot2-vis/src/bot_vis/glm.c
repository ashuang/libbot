 ...
 *
 *
 *  Source obtained from GLUT (v 3.6) at progs/demos/smooth
 *
 *  Changes:
 *     [mwalter, Dec 4 2010]: Added disable of GL_COLOR_MATERIAL in glmDraw
 *                            when GLM_COLOR mode is specified.
 *                            Note: glColorMaterial has been deprecated as of 3.0
 *
 */                           
...
glmDraw(GLMmodel* model, GLuint mode)
{
    ...
    // GLM_COLOR should not be specified as GL_COLOR_MATERIAL has been
    // deprecated as of OpenGL v3.0
    if (mode & GLM_COLOR)
    ...
    // [mwalter Dec 4, 2010] Added to get out of GL_COLOR_MATERIAL mode
    if (mode & GLM_COLOR)// & (gl_color_material_enabled == 0))
        glDisable(GL_COLOR_MATERIAL);
